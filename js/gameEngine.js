...
Game = function (gameName, canvasId) {
    ...
    // Set canvas dimension full screen
    ...
    // Sound Disable because of SAFARI
    /*
    this.soundOn = true;
    this.soundChannels = [];
...
Game.prototype = {
    ...
    // Mouse or Tap listeners..............................................................

	addMouseListener: function (evtNameAndListener) {
		// use vclick from jquery mobile
		$(this.context.canvas).on('v' + evtNameAndListener.mouseEvt, evtNameAndListener.listener);
	},
    ...
    removeSprite: function (sprite) { 
        ...
        var i = this.sprites.lastIndexOf(sprite);
